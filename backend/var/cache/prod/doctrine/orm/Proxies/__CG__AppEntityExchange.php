 ...
 */
class Exchange extends \App\Entity\Exchange implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'offeredItem' => [parent::class, 'offeredItem', null, 16],
        "\0".parent::class."\0".'owner' => [parent::class, 'owner', null, 16],
        "\0".parent::class."\0".'requestedItem' => [parent::class, 'requestedItem', null, 16],
        "\0".parent::class."\0".'requester' => [parent::class, 'requester', null, 16],
        ...
        'offeredItem' => [parent::class, 'offeredItem', null, 16],
        'owner' => [parent::class, 'owner', null, 16],
        'requestedItem' => [parent::class, 'requestedItem', null, 16],
        'requester' => [parent::class, 'requester', null, 16],
